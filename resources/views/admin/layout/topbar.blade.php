                        ...
                        <ul
                            ...
                            <li class="nav-item">
                                <a role="tab" class="nav-link active" data-toggle="tab"
                                    href="index.html#tab-messages-header">
                                    <span>Messages</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a role="tab" class="nav-link" data-toggle="tab"
                                    href="index.html#tab-events-header">
                                    <span>Events</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a role="tab" class="nav-link" data-toggle="tab"
                                    href="index.html#tab-errors-header">
                        ...
                        <div class="widget-content-left">
                            <div class="btn-group">
                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                    class="p-0 btn">
                                    <img width="42" class="rounded-circle" src="{{ asset('admin') }}/assets/images/avatars/1.jpg"
                                        alt="">
                                                    ...
                                                    <div class="widget-content-wrapper">
                                                        <div class="widget-content-left mr-3">
                                                            <img width="42" class="rounded-circle"
                                                                src="{{ asset('admin') }}/assets/images/avatars/1.jpg" alt="">
                                                        </div>
                                                        <div class="widget-content-left">
