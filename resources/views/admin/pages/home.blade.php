...
@section('title', 'Home page - Gerenciamento de Conteúdo')
@section('content')
    <div class="app-main__outer">
                                                ...
                                                <div>
                                                    <div class="avatar-icon-wrapper mr-1">
                                                        ...
                                                        <div class="avatar-icon avatar-icon-lg rounded">
                                                            <img src="{{ asset('admin') }}/assets/images/avatars/2.jpg" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                ...
                                                <div class="chat-box-wrapper chat-box-wrapper-right">
                                                    ...
                                                    <div>
                                                        <div class="avatar-icon-wrapper ml-1">
                                                            ...
                                                            <div class="avatar-icon avatar-icon-lg rounded">
                                                                <img src="{{ asset('admin') }}/assets/images/avatars/3.jpg" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        @include('admin.components.footer-bar')
    </div>
@endsection
