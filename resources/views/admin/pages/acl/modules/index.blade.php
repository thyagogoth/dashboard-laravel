        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    <a class="btn btn-primary" href="{{ route('modules.create') }}">Novo cadastro</a>
                </div>
            </div>
        </div>
                ...
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="{{ route('modules.edit', $module->id) }}">editar</a>
                                <a class="btn btn-danger" href="{{ route('modules.destroy', $module->id) }}">remover</a>
                                <a class="btn btn-primary" href="{{ route('modules.resources', $module->id) }}">Adicionar Recursos</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                                ...
                                <ul
                                    ...
                                    <li class="nav-item">
                                        <a role="tab" class="nav-link active" data-toggle="tab"
                                            href="tables-data-tables.html#tab-messages-header1">
                                            <span>Messages</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a role="tab" class="nav-link" data-toggle="tab"
                                            href="tables-data-tables.html#tab-events-header1">
                                            <span>Events</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a role="tab" class="nav-link" data-toggle="tab"
                                            href="tables-data-tables.html#tab-errors-header1">
