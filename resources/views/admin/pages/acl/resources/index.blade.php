        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    <a class="btn btn-primary" href="{{ route('resources.create') }}">Novo cadastro</a>
                </div>
            </div>
        </div>
                ...
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="{{ route('resources.edit', $resource->id) }}">editar</a>
                                <a class="btn btn-danger" href="{{ route('resources.destroy', $resource->id) }}">remover</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
